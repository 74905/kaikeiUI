...
export const KinputForm = ({addForom,selectValues,userDate,kaikeiMonth,kaikeiday,totalAmount,favoriteRoutes,setFavoriteRoutes}) => {
...
<div  class="khMap">
    ...
    <KinputHr />
    <FavoriteBox isOpen={isOpen} onClose={onClose} setFavoStartTrain={setFavoStartTrain} setEndTrain={setEndTrain} favoriteRoutes={favoriteRoutes} setFavoriteRoutes={setFavoriteRoutes} userDate={userDate}></FavoriteBox>
 </div>
</>
  )
}
